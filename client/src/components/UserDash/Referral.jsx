    ...
    return (
        <>
            ...
            <div className="rounded-2xl w-[75%] text-[#1A2421] bg-black [ p-8 md:p-10 lg:p-10 ] border">
                <p className="mb-6 [ text-sm text-[#1A2421]/70 text-opacity-50 ] text-blue-300">Paste Address for Refferal</p>
                <label for="walletAddress" className="form-label relative block mb-4 text-black/50 focus-within:text-[#333]">
                    <input
