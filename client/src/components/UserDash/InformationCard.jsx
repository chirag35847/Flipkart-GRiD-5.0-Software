...
const InformationCard = ({title,value}) => {
    return (
        <div className="flex items-center px-4 py-6  backdrop-blur-lg border  rounded-md shadow-md h-[15vh]">
            ...
            <div className="text-[#4f46e5] font-semibold text-[3rem]">{value}</div>
